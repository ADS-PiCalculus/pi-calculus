...
var Tau = (function () {
    ...
    return (
        (((n.prototype = new Action()).constructor = n).prototype.fire = function () {
...
var Receive = (function () {
    ...
    return (
        (((r.prototype = new Action()).constructor = r).prototype.fire = function (t) {
...
var Send = (function () {
    ...
    return (
        (((o.prototype = new Action()).constructor = o).prototype.fire = function () {
            return this.continuation instanceof Function ? this.continuation() : void 0;
        }),
        (o.prototype.toPiCalc = function () {
            return (
                this.channel.toPiCalc() +
                portToPicalc(this.port) +
                "<" +
                this.args
                    .map(function (t) {
                        return t.toPiCalc();
...
var Alt = (function () {
    ...
    return (
        (n.prototype.enabled_on = function (t, n) {
...
var Config = (function () {
    function c(t, n) {
        ...
        (this.defs = t), (this.names_index = {}), (this.init = n), (this.nodes = []), (this.procsIndex = 0), (this.epoch = 0), (this.links = []), this.mergeCalls(n, { x: 0, y: 0 }), this.recomputeLinks();
    }
    function a(t) {
        var n = 60;
    ...
    function s(t, n) {
        return null != t && "x" in t && "y" in t ? (null != n && "x" in n && "y" in n ? { x: (t.x + n.x) / 2, y: (t.y + n.y) / 2 } : { x: t.x, y: t.y }) : void 0;
    }
    function u(t) {
              ...
              t.forEach(function (t) {
                  if (t) {
                      t.args.forEach(function (t) {
                          t in i.names_index || ((i.names_index[t] = { refCount: 0, age: 0 }), null != e && ((t.x = a(e.x)), (t.y = a(e.y))), r.push(t)), i.names_index[t].refCount++;
                      });
                      var n = { call: t, body: i.defs.unfold(t), age: i.epoch };
                      void 0 !== t.x && void 0 !== t.y ? ((n.x = t.x), (n.y = t.y), t.fixed && (n.fixed = !0)) : null != e && ((n.x = a(e.x)), (n.y = a(e.y))), o.push(n);
                  }
              }),
              this.nodes.unshift.apply(this.nodes, r),
              this.nodes.push.apply(this.nodes, o),
              (this.procsIndex += r.length),
              { names: r, procs: o });
    }),
        ...
        (c.prototype.redexes = function () {
            for (var n = this.procsIndex, t = []; n < this.nodes.length; ) {
                if (this.nodes[n].body) {
                    var e = this.nodes[n];
                    t = t.concat(
                        e.body.taus().map(function (t) {
                            return { type: "tau", index: n, action: t, process: e };
                        })
                    );
                }
                n++;
            ...
            for (var r = [], o = 0; o < this.procsIndex; ) {
                for (var i = [], a = [], n = this.procsIndex; n < this.nodes.length; ) {
                    if (this.nodes[n].body) {
                        var e,
                            c = (e = this.nodes[n]).body.receiving_on(this.nodes[o]),
                            s = e.body.sending_on(this.nodes[o]);
                        c.forEach(function (t) {
                            a.push({ index: n, action: t, process: e });
                        }),
                            s.forEach(function (t) {
                                i.push({ index: n, action: t, process: e });
                            });
                    }
                    n++;
                }
                for (var u = 0, l = !1; u < i.length; ) {
                    for (var p = 0; p < a.length; ) {
                        var f = i[u],
                            h = a[p];
                        f.index != h.index && f.action.port == h.action.port && f.action.arity == h.action.arity && (r.push({ type: "comm", sender: f, receiver: h }), (l = !0)), p++;
                    }
                    u++;
                }
    ...
    return (
        ...
        (c.prototype.removeProc = function (t) {
            ...
            return (
                this.nodes[t].call.args.forEach(function (t) {
                    n[t].refCount--;
                }),
...
var PiCalcSimulation = (function () {
    var P = d3.scale.category20(),
        _ = { nameSize: 5, procWidth: 18, procHeight: 12 },
        k = /^(.*)_(\d*)$/;
    function z(t, n, a) {
        ...
        var p = d3.layout
            ...
            .linkStrength(function (t) {
                return t.target.global ? 0.01 : 0.9;
            })
            .friction(0.8)
            .nodes(o.nodes)
            .links(o.links);
        ...
        var h = t.select("#links").selectAll(".link"),
            ...
            y = d3.behavior
                .zoom()
                .scaleExtent([-10, 10])
                .translate([f.attr("width") / 2, f.attr("height") / 2])
                .on("zoom", function () {
        ...
        f.call(y),
            ...
            (this.legend = function () {
                var t = [];
                for (var n in c) "Ghost" !== n && t.push({ name: n, color: c[n] });
                return t;
            }),
        ...
        this.update = function () {
            (h = h.data(o.links)),
                (d = d.data(o.getNames(), function (t) {
                    return t.toString();
                })),
                ...
                h.exit().remove(),
                h.enter().append("line").classed("link", !0),
                h.classed("global", function (t) {
                ...
                d.exit().remove(),
                d.classed("fixed", function (t) {
                    return t.fixed;
                }),
                d
                    .enter()
                    .append("circle")
                    .classed({ node: !0, name: !0 })
                    .classed("global", function (t) {
                        return t.global;
                    })
                    .attr("r", a.nameSize)
            ...
            return (
                ...
                g
                    ...
                    .append("rect")
                    .attr("class", "node seq")
                    .attr("width", a.procWidth)
                    .attr("height", a.procHeight)
                    .attr("x", function (t) {
                        return t.x - n;
                    })
                    .attr("y", function (t) {
...
!(function (t) {
    ...
    function e(u, t) {
        ...
        var l = {},
            ...
            f = bn(":=", !1),
            h = function (t, n) {
                return { pvar: t.pvar, def: { args: t.args, body: n } };
            },
            d = zn("term"),
            g = function (t, n) {
                return n;
            ...
            r = zn("process call"),
            o = function (t, n) {
                return (t.type = "PiCall"), n && (t.pos = { x: n.x, y: n.y, fixed: !0 }), xe([t]);
            },
            P = zn("fixed position"),
            _ = "@(",
            k = bn("@(", !1),
            ...
            M = function (t, n) {
                return null == n && (n = xe([])), { action: t, cont: n };
            },
            W = function (t) {
                return Ce([t]);
            },
            ...
            Y = zn("input action"),
            Q = function (t, n, e) {
                return { channel: t, port: null == n ? "" : n, type: "input", args: me(e), loc: Cn() };
            },
            V = zn("output action"),
            X = "<",
            tt = bn("<", !1),
            ...
            et = bn(">", !1),
            rt = function (t, n, e) {
                return { channel: t, port: null == n ? "" : n, type: "output", args: me(e), loc: Cn() };
            },
            ot = function () {
                return { type: "tau", loc: Cn() };
            },
            it = "@",
            at = bn("@", !1),
            ct = function (t) {
            ...
            st = function (t, n) {
                return { pvar: t, args: me(n), loc: Cn() };
            },
            ut = zn("restriction"),
            lt = function (t, n) {
                return 0 == t.length ? n : "New" == n.type ? { type: "New", names: t.concat(n.names), proc: n.proc } : { type: "New", names: t, proc: n };
            },
            pt = function (t) {
                return t;
            },
            ...
            wt = function (t) {
                return { name: t, loc: Cn() };
            },
            At = zn("process identifier"),
            bt = /^[A-Z]/,
            Pt = Pn([["A", "Z"]], !1, !1),
            _t = /^[a-zA-Z0-9'_]/,
            kt = Pn([["a", "z"], ["A", "Z"], ["0", "9"], "'", "_"], !1, !1),
            zt = zn("name"),
            $t = /^[a-z]/,
            St = Pn([["a", "z"]], !1, !1),
            jt = "tau",
        ...
        function Pn(t, n, e) {
            return { type: "class", parts: t, inverted: n, ignoreCase: e };
        }
        function _n() {
            return { type: "any" };
        }
        ...
        function $n(t) {
            ...
            if (n) return n;
            for (e = t - 1; !dn[e]; ) e--;
            for (n = { line: (n = dn[e]).line, column: n.column }; e < t; ) 10 === u.charCodeAt(e) ? (n.line++, (n.column = 1)) : n.column++, e++;
            return (dn[t] = n);
        }
        function Sn(t, n) {
            var e = $n(t),
        ...
        function Tn() {
            ...
            return (
                ...
                (t =
                    (n = Vn()) !== l && (e = he()) !== l
                        ? (u.substr(fn, 2) === p ? ((r = p), (fn += 2)) : ((r = l), 0 === mn && jn(f)), r !== l && (o = he()) !== l && (i = Mn()) !== l ? ((hn = t), (n = h(n, i))) : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(s)),
                t
        ...
        function Fn() {
            var t, n, e, r, o, i, a, c;
            if ((mn++, (t = fn), (n = Ln()) !== l)) {
                for (e = [], r = fn, r = (o = he()) !== l && (i = se()) !== l && (a = he()) !== l && (c = Ln()) !== l ? ((hn = r), (o = g(n, c))) : ((fn = r), l); r !== l; )
                    e.push(r), (r = fn), (r = (o = he()) !== l && (i = se()) !== l && (a = he()) !== l && (c = Ln()) !== l ? ((hn = r), (o = g(n, c))) : ((fn = r), l));
            ...
            return (
                ...
                (t = pe()) === l &&
                    ...
                    (t = n) === l &&
                        ...
                        (t = n) === l &&
                            ((t = fn),
                            40 === u.charCodeAt(fn) ? ((n = y), fn++) : ((n = l), 0 === mn && jn(x)),
                            (t =
                                n !== l && (e = he()) !== l && (r = Fn()) !== l && (o = he()) !== l
                                    ? (41 === u.charCodeAt(fn) ? ((i = C), fn++) : ((i = l), 0 === mn && jn(w)), i !== l ? ((hn = t), (n = A(r))) : ((fn = t), l))
                                    : ((fn = t), l)) === l && ((t = fn), (n = Mn()) !== l && ((hn = t), (n = b(n))), (t = n))))),
                mn--,
                t === l && ((n = l), 0 === mn && jn(d)),
                t
            );
        ...
        function Gn() {
            ...
            return (
                mn++,
                (t = fn),
                u.substr(fn, 2) === _ ? ((n = _), (fn += 2)) : ((n = l), 0 === mn && jn(k)),
                (t =
                    n !== l && (e = he()) !== l && (r = qn()) !== l && (o = he()) !== l
                        ? (44 === u.charCodeAt(fn) ? ((i = z), fn++) : ((i = l), 0 === mn && jn($)),
                          i !== l && (a = qn()) !== l && (c = he()) !== l ? (41 === u.charCodeAt(fn) ? ((s = C), fn++) : ((s = l), 0 === mn && jn(w)), s !== l ? ((hn = t), (n = S(r, a))) : ((fn = t), l)) : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(P)),
                t
        ...
        function qn() {
            ...
            if (((t = fn), j.test(u.charAt(fn)) ? ((n = u.charAt(fn)), fn++) : ((n = l), 0 === mn && jn(E)), n === l && (n = null), n !== l)) {
                if (((e = []), I.test(u.charAt(fn)) ? ((r = u.charAt(fn)), fn++) : ((r = l), 0 === mn && jn(N)), r !== l)) for (; r !== l; ) e.push(r), I.test(u.charAt(fn)) ? ((r = u.charAt(fn)), fn++) : ((r = l), 0 === mn && jn(N));
                else e = l;
        ...
        function Mn() {
            var t, n, e, r, o, i, a, c;
            if (((t = fn), (n = Wn()) !== l)) {
                for (e = [], r = fn, r = (o = he()) !== l && (i = ue()) !== l && (a = he()) !== l && (c = Wn()) !== l ? ((hn = r), (o = T(n, c))) : ((fn = r), l); r !== l; )
                    e.push(r), (r = fn), (r = (o = he()) !== l && (i = ue()) !== l && (a = he()) !== l && (c = Wn()) !== l ? ((hn = r), (o = T(n, c))) : ((fn = r), l));
        ...
        function Wn() {
            ...
            return (
                ...
                (t =
                    (n = Dn()) !== l && (e = he()) !== l
                        ? ((r = fn),
                          46 === u.charCodeAt(fn) ? ((o = R), fn++) : ((o = l), 0 === mn && jn(G)),
                          (r = o !== l && (i = he()) !== l && (a = Zn()) !== l ? ((hn = r), (o = q(n, a))) : ((fn = r), l)) === l && (r = null),
                          r !== l ? ((hn = t), (n = M(n, r))) : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(L)),
                t
        ...
        function Hn() {
            ...
            return (
                (t = Rn()) === l &&
                    ((t = fn),
                    40 === u.charCodeAt(fn) ? ((n = y), fn++) : ((n = l), 0 === mn && jn(x)),
                    (t = n !== l && (e = he()) !== l && (r = Fn()) !== l && (o = he()) !== l ? (41 === u.charCodeAt(fn) ? ((i = C), fn++) : ((i = l), 0 === mn && jn(w)), i !== l ? ((hn = t), (n = A(r))) : ((fn = t), l)) : ((fn = t), l)) ===
                        l && ((t = fn), (n = Un()) !== l && ((hn = t), (n = Z(n))), (t = n))),
                t
            );
        }
        function Jn() {
            ...
            return (
                mn++,
                (t = fn),
                42 === u.charCodeAt(fn) ? ((n = J), fn++) : ((n = l), 0 === mn && jn(D)),
                (t = n !== l && (e = he()) !== l && (r = Hn()) !== l ? ((hn = t), (n = B(r))) : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(H)),
                t
            );
            ...
            return (
                ...
                (t =
                    (n = ae()) !== l
                        ? ((e = Qn()) === l && (e = null),
                          e !== l && (r = he()) !== l
                              ? (40 === u.charCodeAt(fn) ? ((o = y), fn++) : ((o = l), 0 === mn && jn(x)),
                                o !== l && (i = he()) !== l
                                    ? ((a = ee()) === l && (a = null),
                                      a !== l && (c = he()) !== l ? (41 === u.charCodeAt(fn) ? ((s = C), fn++) : ((s = l), 0 === mn && jn(w)), s !== l ? ((hn = t), (n = Q(n, e, a))) : ((fn = t), l)) : ((fn = t), l))
                                    : ((fn = t), l))
                              : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
            ...
            return (
                ...
                (t =
                    (n = ae()) !== l
                        ? ((e = Qn()) === l && (e = null),
                          e !== l && (r = he()) !== l
                              ? (60 === u.charCodeAt(fn) ? ((o = X), fn++) : ((o = l), 0 === mn && jn(tt)),
                                o !== l && (i = he()) !== l
                                    ? ((a = ee()) === l && (a = null),
                                      a !== l && (c = he()) !== l ? (62 === u.charCodeAt(fn) ? ((s = nt), fn++) : ((s = l), 0 === mn && jn(et)), s !== l ? ((hn = t), (n = rt(n, e, a))) : ((fn = t), l)) : ((fn = t), l))
                                    : ((fn = t), l))
                              : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
        ...
        function Xn() {
            ...
            return (
                ...
                (t = fn),
                (t =
                    (n = le()) !== l && (e = he()) !== l && (r = te()) !== l && (o = he()) !== l
                        ? (46 === u.charCodeAt(fn) ? ((i = R), fn++) : ((i = l), 0 === mn && jn(G)), i !== l && (a = he()) !== l ? ((c = Zn()) === l && (c = Xn()), c !== l ? ((hn = t), (n = lt(r, c))) : ((fn = t), l)) : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(ut)),
                t
        ...
        function te() {
            ...
            return (
                (t = fn),
                40 === u.charCodeAt(fn) ? ((n = y), fn++) : ((n = l), 0 === mn && jn(x)),
                (t = n !== l && (e = he()) !== l && (r = re()) !== l && (o = he()) !== l ? (41 === u.charCodeAt(fn) ? ((i = C), fn++) : ((i = l), 0 === mn && jn(w)), i !== l ? ((hn = t), (n = pt(r))) : ((fn = t), l)) : ((fn = t), l)) ===
                    l && (t = re()),
                t
            );
        }
        function ne() {
            ...
            return (
                mn++,
                (t = fn),
                91 === u.charCodeAt(fn) ? ((n = ht), fn++) : ((n = l), 0 === mn && jn(dt)),
                (t =
                    n !== l && (e = he()) !== l
                        ? ((r = ee()) === l && (r = null), r !== l && (o = he()) !== l ? (93 === u.charCodeAt(fn) ? ((i = gt), fn++) : ((i = l), 0 === mn && jn(vt)), i !== l ? ((hn = t), (n = mt(r))) : ((fn = t), l)) : ((fn = t), l))
                        : ((fn = t), l)),
                mn--,
                t === l && ((n = l), 0 === mn && jn(ft)),
                t
        ...
        function ee() {
            ...
            if ((mn++, (t = fn), (n = ae()) !== l))
                if ((e = he()) !== l) {
                    for (r = [], o = fn, 44 === u.charCodeAt(fn) ? ((i = z), fn++) : ((i = l), 0 === mn && jn($)), o = i !== l && (a = he()) !== l && (c = ae()) !== l ? ((hn = o), (i = xt(n, c))) : ((fn = o), l); o !== l; )
                        r.push(o), (o = fn), 44 === u.charCodeAt(fn) ? ((i = z), fn++) : ((i = l), 0 === mn && jn($)), (o = i !== l && (a = he()) !== l && (c = ae()) !== l ? ((hn = o), (i = xt(n, c))) : ((fn = o), l));
        ...
        function re() {
            ...
            if ((mn++, (t = fn), (n = oe()) !== l))
                if ((e = he()) !== l) {
                    for (r = [], o = fn, 44 === u.charCodeAt(fn) ? ((i = z), fn++) : ((i = l), 0 === mn && jn($)), o = i !== l && (a = he()) !== l && (c = oe()) !== l ? ((hn = o), (i = xt(n, c))) : ((fn = o), l); o !== l; )
                        r.push(o), (o = fn), 44 === u.charCodeAt(fn) ? ((i = z), fn++) : ((i = l), 0 === mn && jn($)), (o = i !== l && (a = he()) !== l && (c = oe()) !== l ? ((hn = o), (i = xt(n, c))) : ((fn = o), l));
                    t = r !== l ? ((hn = t), (n = Ct(n, r))) : ((fn = t), l);
                } else (fn = t), (t = l);
            else (fn = t), (t = l);
            return mn--, t === l && ((n = l), 0 === mn && jn(yt)), t;
            ...
            if ((mn++, (t = fn), u.substr(fn, 2) === tn ? ((n = tn), (fn += 2)) : ((n = l), 0 === mn && jn(nn)), n !== l)) {
                for (
                    e = [],
                        o = r = fn,
                        mn++,
                        u.substr(fn, 2) === en ? ((i = en), (fn += 2)) : ((i = l), 0 === mn && jn(rn)),
                        mn--,
                        r = (o = i === l ? void 0 : ((fn = o), l)) !== l ? (u.length > fn ? ((i = u.charAt(fn)), fn++) : ((i = l), 0 === mn && jn(on)), i !== l ? (o = [o, i]) : ((fn = r), l)) : ((fn = r), l);
                    r !== l;
        ...
        function xe(t) {
            return { type: "Parall", components: t };
        }
        function Ce(t) {
            return { type: "Alt", components: t };
        }
        function we(t) {
            return { type: "Bang", components: t };
        }
        function Ae(t, n) {
            return t.type != n.type && An("Merging uncompatible objects " + t.type + " and " + n.type), { type: t.type, components: t.components.concat(n.components) };
        }
        function be(t, n) {
            var e = t;
    ...
    n(Pe, Error),
        ...
        (t.parsePi = { SyntaxError: Pe, parse: e });
})(this),
    (function () {
        function lookup(t) {
        ...
        function compile(txt) {
            ...
            var prog = { defs: {}, init: [], sourceCode: txt },
                defs = ast.defs,
                cdefs = [];
        ...
        function check_free_names(t, n) {
            if ("New" === t.type)
                check_free_names(
                    t.proc,
                    n.concat(
                        t.names.map(function (t) {
                            return t.name;
                        })
                    )
                );
            else if ("PiCall" === t.type) {
                for (var e in t.args) if (n.indexOf(t.args[e]) < 0) throw stxerr("Name '" + t.args[e] + "' out of scope.", t.loc);
            } else if ("Parall" === t.type) for (var e in t.components) check_free_names(t.components[e], n);
            else {
        ...
        (window.parsePi.compile = compile),
            (window.parsePi.validate = validate_syntax),
            (window.parsePi.compileAndCheck = function (t) {
...
function suiteFromGist(t, o) {
    var i = { source: "gist", successful: !0, programs: {} },
        a,
        c = function () {
            if (!0 === i.successful) {
                var n, t;
                ...
                for (var e in (n.default && n.default + ".pi" in a.files && (i.default = n.default), delete n.default, a.files))
                    if (e.endsWith(".pi")) {
                        var r = e.slice(0, -3);
                        if (((i.programs[r] = { name: r, sourceCode: a.files[e].content, options: $.extend({}, n) }), r + ".json" in a.files))
                            try {
    ...
    n ? (t = "https://api.github.com/gists/" + n[2]) : t.startsWith("http") || (t = "https://api.github.com/gists/" + t),
        $.ajax(t, {
            cache: !0,
            success: function (t) {
...
function createGistFromSuite(t, n, e) {
    var r = { description: t.description, public: !1, files: {} };
    for (var o in t.programs) (r.files[o + ".pi"] = { content: t.programs[o].sourceCode }), $.isEmptyObject(t.programs[o].options) || (r.files[o + ".json"] = { content: JSON.stringify(t.programs[o].options) });
    return $.ajax({ url: "https://api.github.com/gists", type: "POST", data: JSON.stringify(r), success: n, error: e }), r;
}
var Stargazer = (function () {
    ...
    function k(t, n, e) {
        ...
        var r,
            o = +(e = $.extend({ zoom: 1, delay: 500, gravity: !0, showLabels: !0, playOnLoad: !1, autoFreeze: !0, autoResize: !0 }, e)).zoom,
            i = e.palette ? { palette: e.palette } : void 0,
            a = d3.select(t);
        ...
        (this.simulator = function () {
            ...
            (this.resizeCanvas = p),
            e.autoResize && ($(a.node()).on("div-resize", p), p()),
            (this.gravity = function (t) {
                if (void 0 === t) return 0.05 < r.layout().gravity();
                t ? r.layout().gravity(0.2).charge(-400).start() : r.layout().gravity(1e-5).charge(-30).start();
            }),
        ...
        var m = $("<div class='controls'></div>").appendTo(a.node()),
            y = $("<div class='control play'></div>")
                .click(function () {
                    g ? w.pause() : w.play();
                })
                .appendTo(m),
            x = $("<div class='control open'></div>")
                .click(function () {
                    w.pause(), window.open(_ + (e.link || "?program=" + encodeURIComponent(s)));
                })
                .appendTo(m),
            C = $("<div class='control reset'></div>")
                .click(function () {
                    w.reset();
                })
                .appendTo(m);
        ...
        (this.autoFreeze = A),
            e.autoFreeze && $(a.node()).on("view-change", A),
            (this.showLabels = function (t) {
            ...
            e.showLabels && this.showLabels(e.showLabels),
            e.showGlobals && this.showLabels(e.showGlobals);
    }
    function z(t) {
...
$(function () {
    ...
    function t(n, e) {
        var r = { name: void 0, sourceCode: "0", source: "none", sourceId: "", options: {} };
        ...
        if (
            ...
            (r.options.showLabels = "true" === n.attr("data-labels") || n.hasClass("labels")),
            (r.options.showGlobals = "true" === n.attr("data-globals") || n.hasClass("globals")),
            (r.options.playOnLoad = "true" === n.attr("data-play-on-load")),
            (r.options.delay = n.attr("data-delay")),
            (r.options.zoom = n.attr("data-zoom")),
            (r.name = n.attr("data-program")),
            n.attr("data-gist"))
        ) {
            if (((r.source = "gist"), (r.sourceId = n.attr("data-gist")), !(r.sourceId in o)))
                return suiteFromGist(r.sourceId, function (t) {
    ...
    $("div.stargazer").each(function (t) {
        var n = $(this),
            e = this;
        n.addClass("loading").removeClass("error"),
            r(n, function (t) {
...
window.onload = function() {
    ...
    function piCalculusHint(editor) {
        ...
        var piCalculusKeywords = [
          "x<y>.P","match", "case", "a(x).P", "M[p,q]", "T[x]"
        ];
