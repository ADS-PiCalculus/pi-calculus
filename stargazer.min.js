                ...
                Config = function() {
                    ...
                    return c.prototype.next = function(t) {
                        ...
                        var t = "",
                            ...
                            e = this.getProcs();
                        return 0 < n.length && (t += "ν" + n.map(function(t) {
                            return t.toPiCalc()
...
window.onload = function() {
    // Define the custom piCalculus mode
    CodeMirror.defineMode('piCalculus', function() {
        ...
        var keywordRegex = new RegExp("\\b(" + Object.keys(keywords).join("|") + ")\\b", "i");

        return {
            token: function(stream, state) {
                if (stream.match(keywordRegex)) {
                    return keywords[stream.current()];
                }
                stream.next();
                return null;
            }
    ...
    var editor = CodeMirror.fromTextArea(document.getElementById('code-editor'), {lineNumbers: true,mode: 'piCalculus',extraKeys: {"Ctrl-Space": "autocomplete"},hintOptions: {completeSingle: false}});

    // Define the hint function for piCalculus keywords
    function piCalculusHint(editor) {
        ...
        var piCalculusKeywords = ["x<y>.P", "tau", "new", "Parallel"];
    ...
    // Bind Shift-Space to show hints
    editor.setOption("extraKeys", {
        "Shift-Space": function(cm) {
            cm.showHint({hint: piCalculusHint, completeSingle: true});
        }
    });
